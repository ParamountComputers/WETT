...
public partial class WETT_DBContext : DbContext
{
    ...
    public virtual DbSet<MbllCustomerFile> MbllCustomerFiles { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<CustomerOrder>(entity =>
        {
            ...
            entity.HasOne(d => d.Carrier).WithMany(p => p.CustomerOrders)
            ...
            entity.HasOne(d => d.CustomerOrderStatus).WithMany(p => p.CustomerOrders)
                .HasForeignKey(d => d.CustomerOrderStatusId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Customer Order_Customer Order Status");

            entity.HasOne(d => d.OrderSource).WithMany(p => p.CustomerOrders)
        ...
        modelBuilder.Entity<CustomerOrderDetail>(entity =>
        {
            ...
            entity.HasOne(d => d.Product).WithMany(p => p.CustomerOrderDetails)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Customer Order Detail_Product Master");
        });
        ...
        modelBuilder.Entity<Inventory>(entity =>
        {
            ...
            entity.HasOne(d => d.InventoryLocation).WithMany(p => p.Inventories)
                .HasForeignKey(d => d.InventoryLocationId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Inventory_Inventory Location");

            entity.HasOne(d => d.InventoryTxDetail).WithMany(p => p.Inventories)
            ...
            entity.HasOne(d => d.Product).WithMany(p => p.Inventories)
                .HasForeignKey(d => d.ProductId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Inventory_Product Master");
        ...
        modelBuilder.Entity<InventoryTx>(entity =>
        {
            ...
            entity.HasOne(d => d.InventoryTxType).WithMany(p => p.InventoryTxes)
                .HasForeignKey(d => d.InventoryTxTypeId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Inventory Tx_Inventory Tx Type");

            entity.HasOne(d => d.ShippingLocation).WithMany(p => p.InventoryTxes)
                .HasForeignKey(d => d.ShippingLocationId)
                .HasConstraintName("FK_Inventory Tx_Shipping Location");

            entity.HasOne(d => d.Supplier).WithMany(p => p.InventoryTxes)
                .HasForeignKey(d => d.SupplierId)
                .HasConstraintName("FK_Inventory Tx_Supplier");

            entity.HasOne(d => d.ToInventoryLocation).WithMany(p => p.InventoryTxToInventoryLocations)
                .HasForeignKey(d => d.ToInventoryLocationId)
                .HasConstraintName("FK_Inventory Tx_To Inventory Location");

            entity.HasOne(d => d.TruckingCompany).WithMany(p => p.InventoryTxes)
        ...
        {
            entity.ToTable("Inventory Tx Detail", tb =>
                {
                    tb.HasTrigger("TAD_InvTxDtls");
                    tb.HasTrigger("TAI_InvTxDtls");
                    tb.HasTrigger("TAU_InvTxDtls");
                });
            ...
            entity.HasOne(d => d.InventoryTx).WithMany(p => p.InventoryTxDetails)
                .HasForeignKey(d => d.InventoryTxId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Inventory Tx Detail_Inventory Tx");

            entity.HasOne(d => d.InventoryTxReason).WithMany(p => p.InventoryTxDetails)
        ...
        modelBuilder.Entity<MbllCustomerFile>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("MBLL Customer File");

            entity.Property(e => e.SourceValue).IsRequired();
        });
        ...
        modelBuilder.Entity<Supplier>(entity =>
        {
            ...
            entity.HasIndex(e => e.SupplierCode, "IX_Supplier").IsUnique();
